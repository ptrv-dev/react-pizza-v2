    ...
    <div className="flex">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center gap-2 flex-1">
        <div className="flex flex-col xl:flex-1">
          <h4 className="font-bold text-lg leading-none">Пицца</h4>
        ...
        <div className="flex flex-col text-sm lg:text-base xl:flex-1">
          <p>
            Цена за шт. - <b className="text-amber-500">220 ₴</b>
          </p>
          <p>
            Цена за все - <b className="text-amber-500">3 х 220 = 660 ₴</b>
          </p>
        </div>
      </div>
      <button className="self-start lg:self-center">
        <svg
          width="36"
          height="36"
          viewBox="0 0 36 36"
